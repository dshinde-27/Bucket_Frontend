...
function Page() {
    ...
    const AddPageBaseUrl = 'https://localhost:7086/api/Page/AddPages';
    const GetPageBaseUrl = 'https://localhost:7086/api/Page/GetPages';
    const EditPageBaseUrl = 'https://localhost:7086/api/Page/EditPage';
