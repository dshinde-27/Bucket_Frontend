...
function State() {
    ...
    const AddStateUrl = 'https://localhost:7086/api/Location/AddState';
    const GetStateUrl = 'https://localhost:7086/api/Location/GetStates';
    const DeleteStateUrl = 'https://localhost:7086/api/Location/DeleteState';
