...
function Role() {
    ...
    const roleApiUrl = 'https://localhost:7086/api/Role';
    const permissionApiUrl = 'https://localhost:7086/api/Permission';
    const pageApiUrl = 'https://localhost:7086/api/Page';
                    ...
                    {showPermissionModal && (
                        <div className='modal-overlay-permission' role="dialog" aria-modal="true">
                            <div className='modal-content-permission'>
                                ...
                                <table className='role-table-permission'>
                                    <thead>
                                        <tr>
                                            <th>Page Name</th>
                                            <th>Sub Page Name</th>
