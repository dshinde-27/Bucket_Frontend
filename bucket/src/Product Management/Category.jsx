                ...
                <div className='role-container'>
                    <div className="role-header">
                        ...
                        <div className="role-actions">
                            <button className="search-icon" onClick={() => setShowSearch(prev => !prev)}><FaSearch /></button>
                            {showSearch && (
                                <input type="text" className="search-box" placeholder="Search categories..." value={searchText} onChange={e => setSearchText(e.target.value)} />
                            )}
                            <button className='add-role-btn' onClick={() => setShowModal(true)}><FaPlus /> Add Category</button>
                        </div>
                    </div>
